...
export default function About() {
  return (
    <section id="about" className="bg-gray-50 py-16 px-4 sm:px-8">
      <div className="max-w-4xl mx-auto space-y-6">
        <h2 className="text-3xl  text-outline-blue sm:text-4xl font-semibold text-[var(--primary-blue)] text-center">
          About Recovery on the Harbor
        </h2>
